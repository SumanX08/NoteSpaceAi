  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full border-b border-white/[0.06] bg-[#050607]/90 backdrop-blur-xl">
      <nav className="mx-auto flex h-[72px] max-w-[1400px] items-center justify-between px-6 lg:px-8">
        ...
        <a
          href="/app"
          className="group hidden items-center gap-2 rounded-xl border border-blue-500/50 bg-blue-500/[0.04] px-5 py-2.5 text-[17px] font-semibold text-slate-100 transition-all duration-300 hover:border-blue-400 hover:bg-blue-500/10 hover:shadow-[0_0_25px_rgba(37,99,235,0.15)] md:flex"
        >
          Get Started
          <ArrowRight
            size={19}
